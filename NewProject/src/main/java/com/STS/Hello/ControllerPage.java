...
public class ControllerPage {
	...
	@RequestMapping(value = {"/login", "/NewProject/login" }, method = RequestMethod.GET)
	...
	@RequestMapping(value = {"/register", "/NewProject/register" }, method = RequestMethod.GET)
	public ModelAndView registerPage() {
		System.out.println("registerpage");
		return new ModelAndView("register", "register", new register());
		
	}
	@RequestMapping(value = {"/index", "/NewProject/index" }, method = RequestMethod.GET)
	public String indexPage() {
		System.out.println("indexpage");
		return "index";
		
	}
	@RequestMapping(value = {"/login_check", "/NewProject/login_check" }, method = RequestMethod.POST)
	...
	@RequestMapping(value = {"/registerEmp", "/NewProject/registerEmp" }, method = RequestMethod.POST)
